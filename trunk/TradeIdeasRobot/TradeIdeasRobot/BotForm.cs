...
namespace TradeIdeasRobot
{
    public partial class BotForm : Form
    {
        ...
        private void btnOpenAlerts_Click(object sender, EventArgs e) {
            ...
            TIAlertsForm w = new TIAlertsForm();
            w.BotForm = this;
    ...
    public class TIWindowLayout
    {
        ...
        [XmlIgnore]
        private List<TIAlertsForm> alertWindows;
        private static Logger log = LogManager.GetCurrentClassLogger();
        ...
        public TIWindowLayout() {
            ...
            alertWindows = new List<TIAlertsForm>();
        }

        public TIAlertsForm AddNewWindow() {
            TIAlertsForm w = new TIAlertsForm();
            w.BotForm = BotForm;
            alertWindows.Add(w);
            w.Show();
        ...
        public void OpenLayout() {
            foreach (TIAlertsForm window in alertWindows) {
                if (window.Visible) {
                    window.Close();
                }
            }
        ...
        public void SaveLayout() {
            AlertStates = new List<TIWindowState>();
            foreach (TIAlertsForm w in alertWindows) {
